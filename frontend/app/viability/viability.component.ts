...
export class ViabilityComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ViabilityComponent>,
    public germinationFormService: ViabilityFormService,
        ...
        if (yes) {
          ...
          if (this.data?.edit) {
            this._commonService.translateToaster(
              'info',
              currentCode
                ? `Test de viabilité ${this.toBoldText(currentCode)} non modifié`
                : 'Test de viabilité non modifié'
            );
          } else if (currentCode) {
            this._commonService.translateToaster(
              'info',
              `Test de viabilité ${this.toBoldText(currentCode)} non créé`
            );
          } else {
            this._commonService.translateToaster(
              'info',
              'Création du test de viabilité annulée'
            );
          }
