            ...
            FROM (
                VALUES
                    (
                        ...
                        'repiquage',
                        'Repiquage',
                        'Action de repiquage d’une Culture',
                        '.001'
                    ),
                    (
                        'remp',
                        'rempotage',
                        'Rempotage',
                        'Action de rempotage d’une Culture',
                        '.002'
                    ),
                    (
                        'plant',
                        'plantation',
                        'Plantation',
                        'Action de plantation d’une Culture',
                        '.003'
                    )
            ) AS v(
                cd_nomenclature,
            ...
            FROM (
                VALUES
                    (
                        ...
                        'siteCulture',
                        'Site de culture',
                        'Localisation principale sur un site de culture',
                        '.001'
                    ),
                    (
                        'labo',
                        'laboratoire',
                        'Laboratoire',
                        'Localisation principale en laboratoire',
                        '.002'
                    ),
                    (
                        'jardin',
                        'jardin',
                        'Jardin',
                        'Localisation principale dans un jardin',
                        '.003'
                    )
            ) AS v(
                cd_nomenclature,
...
def downgrade():
    ...
    """)
    # Suppression de la nomenclature des localisations principales
    op.execute("""
        DELETE FROM ref_nomenclatures.t_nomenclatures
        WHERE id_type = (
            SELECT id_type
